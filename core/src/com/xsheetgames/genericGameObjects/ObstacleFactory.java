...
public class ObstacleFactory extends GameObjectFactory{
	...
	public boolean collideNotWithEnemyFire;
	
	
	public ObstacleFactory(Class<? extends GameObject> c, World w, TextureAtlas a, String aName, BodyEditorLoader loader, String loaderName, 
	...
	public GameObject createObject() {
		return new Obstacle(this.world, GameAssets.emptyVector2, this.atlas, this.atlasName, this.loader, this.loaderName, 
