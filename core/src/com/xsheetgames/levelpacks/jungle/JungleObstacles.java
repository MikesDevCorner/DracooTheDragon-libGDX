...
public class JungleObstacles extends AbstractObstacleCollection {
	...
	public void spawnObstacle(String name, float y) {
		...
		if(o!=null) {
			...
			// name matched no branch above (e.g. a typo/unimplemented obstacle name in the level
			// JSON) - guard against the NPE that a bare o2.setPosition() would throw here.
			if(o2 != null) {
